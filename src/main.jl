...
damages_compare=readpagedata(m,"../../mimi-page.jl/test/validationdata/gdp.csv")-((readpagedata(m,"../../mimi-page.jl/test/validationdata/rcons_per_cap_DiscRemainConsumption.csv")*1/(1-(m[:GDP,:save_savingsrate]/100)).*readpagedata(m,"../../mimi-page.jl/test/validationdata/pop_population.csv"))+readpagedata(m,"../../mimi-page.jl/test/validationdata/tct_totalcosts.csv")+readpagedata(m,"../../mimi-page.jl/test/validationdata/act_adaptationcosts_tot.csv"))
...
conc_compare=readpagedata(m,"../../mimi-page.jl/test/validationdata/c_co2concentration.csv")
...
adapt_compare=vec(sum(readpagedata(m,"../../mimi-page.jl/test/validationdata/act_adaptationcosts_tot.csv"),2))
